...
INSERT INTO "new_Enrollment" ("courseId", "id", "progress", "schoolId", "status", "studentName", "userId") SELECT "courseId", "id", "progress", "schoolId", "status", "studentName", "userId" FROM "Enrollment";
